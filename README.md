...
- `index.html` - the six-phase method walkthrough (discover, define, design, validate, launch, improve)
...
- `css/`, `js/` - vanilla CSS and JavaScript, no frameworks, no build step
